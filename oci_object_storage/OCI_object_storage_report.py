...
# ---------------------------------------------------------------------------------------------------------------------------------
# This script computes the total capacity of object storage used in each compartment in a region or all active regions using OCI Python SDK
# Buckets, block storage backups, 
#
...
# ---- usage syntax
def usage():
    print ("Usage: {} [-a] OCI_PROFILE compartment_ocid".format(sys.argv[0]))
    print ("    or {} [-a] OCI_PROFILE compartment_name".format(sys.argv[0]))  
    print ("")
