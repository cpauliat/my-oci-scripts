...
# --------------------------------------------------------------------------------------------------------------
# This script lists all databases in a OCI tenant using OCI Python SDK and search queries
# It looks in all compartments in the region given by profile or in all subscribed regions
# Note: OCI tenant given by an OCI CLI PROFILE
#
# Author        : Christophe Pauliat, adapted to database by Matthieu Bordonne
# Platforms     : MacOS / Linux
# prerequisites : - Python 3 with OCI Python SDK installed
#                 - OCI config file configured with profiles
# Versions
#    2021-12-10: Initial Version
#    2022-01-04: use argparse to parse arguments
# --------------------------------------------------------------------------------------------------------------
...
# -- parse arguments
parser = argparse.ArgumentParser(description = "List databases")
